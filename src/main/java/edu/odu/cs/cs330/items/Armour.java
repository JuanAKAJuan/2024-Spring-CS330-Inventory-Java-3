...
public class Armour extends Equippable {
    ...
    public boolean equals(Object rhs) {
        ...
        return this.getName().equals(rhsItem.getName()) && this.getMaterial().equals(rhsItem.getMaterial())
                ...
                && this.getElement().equals(rhsItem.getElement()) && this.defense == rhsItem.defense;
    }
    ...
    public String toString() {
        return String.format(FMT_STR, this.name, this.getDurability(), this.defense, this.getMaterial(),
